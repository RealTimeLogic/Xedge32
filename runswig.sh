...
swig -DCONFIG_IDF_TARGET_ESP32=1 -I$IDFP/components/esp32/ -I$IDFP/components/esp_common/include -I$IDFP/components/hal/include -I$IDFP/components/soc/include -I$IDFP/components/soc/esp32/include -I$IDFP/components/driver/include -I$IDFP/components/esp_rom/include -I$IDFP/components/driver/esp32/include -I$IDFP/components/nvs_flash/include -Imain -lua -o main/esp_wrap.c tools/esp.i

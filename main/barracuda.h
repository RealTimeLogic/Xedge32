...
#define BASLIB_VER "4486"
#define BASLIB_VER_NO 4486
...
: public Thread
{
      ...
      size_t set(BaTimer_CB cb, void* data, BaTime milliSec);

      
      int reset(size_t tkey, BaTime milliSec);
...
BA_API size_t BaTimer_set(BaTimer* o, BaTimer_CB cb, void* data, BaTime milliSec);
BA_API int BaTimer_reset(BaTimer* o, size_t tkey, BaTime milliSec);
...
inline size_t BaTimer::set(BaTimer_CB cb, void* data, BaTime milliSec) {
   return BaTimer_set(this, cb, data, milliSec);
}
inline int BaTimer::reset(size_t tkey, BaTime milliSec) {
